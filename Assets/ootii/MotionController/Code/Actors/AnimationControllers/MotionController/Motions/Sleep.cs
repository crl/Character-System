...
namespace com.ootii.Actors.AnimationControllers
{
    ...
    public class Sleep : MotionControllerMotion
    {
        ...
        public override bool TestActivate()
        {
            ...
            // Test if we're supposed to go to sleep
        ...
        public override void Update(float rDeltaTime, int rUpdateIndex)
        {
            ...
            if (mMotionLayer._AnimatorStateID == STATE_Sleeping && mMotionLayer._AnimatorTransitionID == 0)
            {
                if (_ActionAlias.Length > 0 && mMotionController._InputSource != null)
                {
                    if (mMotionController._InputSource.IsJustPressed(_ActionAlias))
        ...
        public override bool OnInspectorGUI()
        {
            ...
            if (EditorHelper.TextField("Action Alias", "Action alias that starts the sleeps and then exits the sleep.", ActionAlias, mMotionController))
            {
                lIsDirty = true;
