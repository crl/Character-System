...
namespace com.ootii.Actors.AnimationControllers
{
    ...
    public class ClimbWall : MotionControllerMotion
    {
        ...
        public virtual bool TestForClimbDownBack()
        {
            ...
            // First shoot a ray forward to see if we can get to the ledge
            Vector3 lRayStart = mActorController._Transform.position + (mActorController._Transform.rotation * new Vector3(0f, mActorController._MaxStepHeight, 0f));
            Vector3 lRayDirection = -mMotionController._Transform.forward;
            float lRayDistance = _MaxDistance;
            ...
            lRayDirection = -mMotionController._Transform.up;
            lRayDistance = mActorController._MaxStepHeight + 0.1f;
