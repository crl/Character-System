...
namespace com.ootii.Actors.AnimationControllers
{
    ...
    public class Climb_1m : MotionControllerMotion
    {
        ...
        public override void OnSettingsGUI()
        {
            ...
            mClimb_1m = CreateAnimationField("Climb_1m", "Assets/ootii/MotionController/Content/Animations/Humanoid/Climbing/unity_Idle_JumpUpMedium_2Hands_Idle.fbx/Climb_1m.anim", "Climb_1m", mClimb_1m);
            mIdleStart = CreateAnimationField("IdleStart", "Assets/ootii/MotionController/Content/Animations/Humanoid/Idling/unity_Idle_IdleToIdlesR.fbx/IdleStart.anim", "IdleStart", mIdleStart);
