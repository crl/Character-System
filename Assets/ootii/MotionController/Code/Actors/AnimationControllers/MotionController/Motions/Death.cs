...
namespace com.ootii.MotionControllerPacks
{
    ...
    public class Death : MotionControllerMotion
    {
        ...
        public override bool Activate(MotionControllerMotion rPrevMotion)
        {
            ...
            // Activate the motion
            mMotionController.SetAnimatorMotionPhase(mMotionLayer._AnimatorLayerIndex, PHASE_START, 180, false);
        ...
        public override void Update(float rDeltaTime, int rUpdateIndex)
        {
            ...
            if (mMotionLayer._AnimatorTransitionID == TRANS_EntryState_Death_0 ||
            ...
            if (mMotionLayer._AnimatorStateID == STATE_Death_0 ||
                mMotionLayer._AnimatorStateID == STATE_Death_180)
            {
